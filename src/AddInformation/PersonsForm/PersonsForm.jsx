...
import s from "./PersonsForm.module.css";
...
const PersonsForm = (props) =>{
  ...
  //document.getElementByd('form').addEventListener('load', props.check)
  //document.getElementsByClassName('addButton').onClick = () =>{
    //console.log(1111)
 // }
  ...
  return(
    <div className={`${s.form} form`} id="form" >
      ...
      <div >
        <label  className={s.gender} ><sup><input type="radio" className={s.Female} name="gender" id="Female" checked={true}/></sup> Female</label>
				<label className={s.gender}  ><sup><input type="radio" className={s.Male} name="gender" id="Male"/></sup> Male</label>
				<label className={s.gender} ><sup><input  type="radio" className={s.Custom} name="gender" id="Custom"/></sup> Custom</label>
			</div>
